...
const ExternalSellInfoPanel: React.FC<SellInfoPanelProps> = ({ onClose, onContinue, token, sellData }) => {
    const {
        qrData,
        amounts,
        cancelTransaction,
        ...
        <div className="bg-white rounded-[1.25rem] w-full h-[80vh] md:h-[90vh] max-w-md p-4 flex flex-col border-2 border-[#3E5EF5] shadow-lg">
            ...
            <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center">
                ...
                <div className="w-full max-w-xs">
                         <TileApp
                title={formatCryptoAddressCustom(sellData?.destinationWalletAddress ?? '', 15, 4)}
