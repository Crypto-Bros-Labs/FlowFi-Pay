...
import ComboBoxApp, { type ComboBoxOption } from "../../../../shared/components/ComboBoxApp";
...
const SelectWalletDynamicPage: React.FC<SelectWalletDynamicPageProps> = (props) => {
    ...
    const handleWalletSelectLocal = (walletAddress: ComboBoxOption) => {
        handleWalletSelect(walletAddresses.find(w => w.id === walletAddress.id)?.address || '');
                ...
                <div className="flex-1 overflow-y-auto py-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                    ...
                    {finalAddress && isValidAddress(finalAddress) && (
                        <div className="px-2 mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                            <p className="text-xs text-green-600 mb-1">Dirección seleccionada:</p>
