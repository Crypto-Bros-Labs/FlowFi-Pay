    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center flex-1">
          <div
            className={`w-12 h-12 rounded-full ${config.leadingBg} flex items-center justify-center mr-4`}
          >
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <div className="flex items-center gap-3">
            {/* Status Chip */}
            <span
              className={`px-3 py-1 rounded-full text-xs font-medium ${config.chipBg} ${config.chipText}`}
            >
              {config.chipLabel}
            </span>
