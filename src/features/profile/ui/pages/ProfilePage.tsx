...
import TileAppMenu, {
  type MenuOption,
} from "../../../../shared/components/TileAppMenu";
    ...
    <div className="flex flex-col h-full p-4">
      ...
      <div className="flex justify-center mb-2 px-2 gap-1 items-center">
        <span
          ...
          className={`px-3 py-1 rounded-full text-sm font-medium ${currentKycInfo.bgColor} ${currentKycInfo.textColor} cursor-pointer`}
        >
