                ...
                <div className="flex-1 overflow-y-auto py-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-32 text-center">
                            <p className="text-gray-500 text-sm">No hay miembros en el equipo</p>
                            <p className="text-gray-400 text-xs mt-1">Agrega un nuevo miembro para comenzar</p>
                        </div>
                    ) : (
                        <div className="space-y-3 px-0.5">
                            {teamMembers.map((member) => (
                                <TeamTile
                                    ...
                                    onActionClick={(actionId) => handleMemberAction(member.id, actionId)}
                                />
                            ))}
                        </div>
                    )}
