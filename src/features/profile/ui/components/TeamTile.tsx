                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <div className="relative" ref={menuRef}>
                        <button
                            ...
                            title="Más opciones"
                        >
                            <BiChevronDown className={`w-5 h-5 text-gray-600 transition-transform ${isMenuOpen ? 'rotate-180' : ''}`} />
                        </button>
                                ...
                                {actions.map((action, index) => (
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${action.color ? `text-${action.color}-600` : 'text-gray-900'}
                                        `}
                                    >
