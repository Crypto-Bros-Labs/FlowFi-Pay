    ...
    useEffect(() => {
        const fetchWalletData = async () => {
            ...
            try {
                ...
                const sellInfoData = await sellRepository.getRecoveryOrderById(id);

                const sellData = {
                    kycUrl: 'https://example.com/kyc',
                    destinationWalletAddress: `ethereum:${sellInfoData.userWalletAddress}`,
                    id: id
                };
                ...
                setWalletAddress(sellInfoData.userWalletAddress);
            } catch (error) {
