...
const SellInfoPanel: React.FC<SellInfoPanelProps> = ({ onClose, onContinue, token, sellInfoData, orderId }) => {
    const {
        qrData,
        amounts,
        /*cancelTransaction,
        ...
        <div className="bg-white rounded-[1.25rem] w-full h-[80vh] md:h-[90vh] max-w-md p-4 flex flex-col border-2 border-[#3E5EF5] shadow-lg">
            ...
            {isLoadingUserData ? (
                <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center min-w-[340px]">
                    ...
                    <span className="ml-2 text-gray-500 text-center mt-4">Cargando orden...</span>
                </div>
            ) : (
                    ...
                    <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center p-2">
                        ...
                        <div className="w-full max-w-xs">
                            ...
                            <TileApp
                                ...
                                trailing={
                                    <>
                                        <span className="text-base font-semibold text-[#020F1E]">{amountFiat} MXN</span>
                                    </>
                                }
                                className="mb-3"
                            />
                            ...
                            <TileApp
                                ...
                                trailing={
                                    <>
                                        <span className="text-base font-semibold text-[#020F1E]">{amountToken}</span>
                                    </>
                                }
                                className="mb-3"
                            />
                            ...
                            <TileApp
                                ...
                                trailing={
                                    <>
                                        <span className="text-base font-semibold text-[#020F1E]">{networkName}</span>
                                    </>
                                }
                            />
                        </div>
